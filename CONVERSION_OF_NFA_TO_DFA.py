...
nfa[state] = {} 
for j in range(t): 
path = input("path : ") print("Enter end state from state {} travelling through path {} : ".format(state, path)) 
...
for _ in range(len(new_states_list[0])): for i in range(len(path_list)): 
temp = [] 
